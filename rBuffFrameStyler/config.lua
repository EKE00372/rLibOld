  ...
  --buff frame settings
  cfg.buffFrame = {
    pos             = { a1 = "TOPRIGHT", af = "UIParent", a2 = "TOPRIGHT", x = -120, y = -36 },
    ...
    border = {
      texture           = "Interface\\AddOns\\rLibOld\\rBuffFrameStyler\\media\\gloss",
      color             = { r = 0.4, g = 0.35, b = 0.35, },
      classcolored      = false,
    },
    background = {
      show              = true,   --show backdrop
      edgeFile          = "Interface\\AddOns\\rLibOld\\rBuffFrameStyler\\media\\outer_shadow",
  ...
  cfg.debuffFrame = {
    pos             = { a1 = "TOPRIGHT", af = "rBFS_BuffDragFrame", a2 = "BOTTOMRIGHT", x = 0, y = -20 },
    userplaced      = false, --want to place the bar somewhere else?
    rowSpacing      = 10,
    colSpacing      = 2,
    buttonsPerRow   = 10,
